...
public interface Graph {
	 ...
	 *
	 * Precondition: v1 and v2 are verticies in the graph
	 ...
	 * Postcondition: returns an array containing all vertices adjacent to v.
	 *                This method should return an empty array if v has no
	 *                neighbors.
	 */
	 ...
	 *                This method should return an empty array if the graph has
	 *                no vertices.
	 */
